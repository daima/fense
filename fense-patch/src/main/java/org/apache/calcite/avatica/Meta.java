...
public interface Meta {
  ...
  Map<String, String> getDataSource(ConnectionHandle ch, String dsKey);

  List<String> getQueryLog(StatementHandle h, boolean incremental, int fetchSize);
   ...
   * {@link Connection}, {@link java.sql.Statement}, and {@link ResultSet}.</p>
   */
  ConnectionProperties connectionSync(ConnectionHandle ch, ConnectionProperties connProps);

  /** Factory to create instances of {@link org.apache.calcite.avatica.Meta}. */
  interface Factory {
    org.apache.calcite.avatica.Meta create(List<String> args);
  }
   ...
   *
   * @see #getDatabaseProperties(ConnectionHandle)
   */
  enum DatabaseProperty {
    ...
    public <T> T getProp(org.apache.calcite.avatica.Meta meta, ConnectionHandle ch, Class<T> aClass) {
  ...
  class Signature {
    ...
    public static Signature create(
        ...
        @JsonProperty("statementType") StatementType statementType) {
    ...
    public static Signature fromProto(Common.Signature protoSignature) {
      ...
      final StatementType statementType =
          StatementType.fromProto(protoSignature.getStatementType());
  ...
  /** A pojo containing various client-settable {@link Connection} properties.
   *
