 ...
 */
@Data
public abstract class LocalService implements Service {
  final Meta meta;
  ...
  private static String name(String timer) {
    return concat(org.apache.calcite.avatica.remote.LocalService.class, timer);
  }
            ...
            meta.prepareAndExecute(sh, request.sql, request.maxRowCount,
                request.maxRowsInFirstFrame, new Meta.PrepareCallback() {
                  @Override public Object getMonitor() {
                    return org.apache.calcite.avatica.remote.LocalService.class;
                  }
