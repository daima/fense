...
public class StatementInfo {
  protected volatile Boolean relativeSupported = null;

  protected final Statement statement; // sometimes a PreparedStatement
  ...
  protected boolean resultsInitialized = false;
  ...
  protected boolean advanceByRelative(ResultSet results, long offset) throws SQLException {
  ...
  protected boolean advanceByNext(ResultSet results, long offset) throws SQLException {
