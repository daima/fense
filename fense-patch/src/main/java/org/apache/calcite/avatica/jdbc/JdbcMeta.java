...
@Data
public abstract class JdbcMeta implements ProtobufMeta {
  protected static final Logger LOG = LoggerFactory.getLogger(JdbcMeta.class);

  protected static final String CONN_CACHE_KEY_BASE = "avatica.connectioncache";

  protected static final String STMT_CACHE_KEY_BASE = "avatica.statementcache";
  ...
  protected final AtomicInteger statementIdGenerator = new AtomicInteger();

  protected final String url;
  protected final Properties info;
  protected final Cache<String, Connection> connectionCache;
  protected final Cache<Integer, StatementInfo> statementCache;
  ...
  protected static Object addProperty(Map<DatabaseProperty, Object> map,
   ...
   */
  protected int registerMetaStatement(ResultSet rs) throws SQLException {
   ...
   */
  protected void setMaxRows(Statement statement, long maxRowCount) throws SQLException {
  ...
  protected static String[] toArray(List<String> typeList) {
    if (typeList == null) {
      return null;
    }
  ...
  protected class ConnectionExpiryHandler
  ...
  protected class StatementExpiryHandler
