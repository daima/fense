...
public abstract class AbstractService implements Service {
    ...
    public PrepareResponse finagle(PrepareResponse response) {
    ...
    public ResultSetResponse finagle(ResultSetResponse r) {
        if (r.updateCount != -1) {
    ...
    public DataSourceResponse finagle(DataSourceResponse r) {
        return new DataSourceResponse(r.props, rpcMetadata);
    }

    public QueryLogResponse finagle(QueryLogResponse r) {
        return new QueryLogResponse(r.logs, rpcMetadata);
    }
