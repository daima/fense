...
public interface Service {
  ...
  ResultSetResponse apply(FunctionsRequest functionsRequest);
  DataSourceResponse apply(DataSourceRequest dataSourceRequest);
  QueryLogResponse apply(QueryLogRequest queryLogRequest);
  ...
  interface Factory {
    org.apache.calcite.avatica.remote.Service create(AvaticaConnection connection);
  }
  ...
  @JsonSubTypes({
      ...
      @JsonSubTypes.Type(value = FunctionsRequest.class, name = "getFunctions"),
      @JsonSubTypes.Type(value = DataSourceRequest.class, name = "getDataSource"),
      @JsonSubTypes.Type(value = QueryLogRequest.class, name = "getQueryLog"),
  ...
  abstract class Request extends Base {
    abstract Response accept(org.apache.calcite.avatica.remote.Service service);
  ...
  /** Request for
   * {@link Meta#getCatalogs(Meta.ConnectionHandle)}. */
  class CatalogsRequest extends Request {
    ...
    ResultSetResponse accept(org.apache.calcite.avatica.remote.Service service) {
  ...
  class DatabasePropertyRequest extends Request {
    ...
    DatabasePropertyResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class TablesRequest extends Request {
    ...
    @Override Response accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Request for
   * {@link Meta#getFunctions(Meta.ConnectionHandle, String, Meta.Pat, Meta.Pat)}
   */
  class FunctionsRequest extends Request {
    private static final FieldDescriptor CONNECTION_ID_DESCRIPTOR = Requests.FunctionsRequest.
            getDescriptor().findFieldByNumber(Requests.FunctionsRequest.CONNECTION_ID_FIELD_NUMBER);
    private static final FieldDescriptor CATALOG_DESCRIPTOR = Requests.FunctionsRequest.
            getDescriptor().findFieldByNumber(Requests.FunctionsRequest.CATALOG_FIELD_NUMBER);
    private static final FieldDescriptor SCHEMA_PATTERN_DESCRIPTOR = Requests.FunctionsRequest.
            getDescriptor().findFieldByNumber(Requests.FunctionsRequest.SCHEMA_PATTERN_FIELD_NUMBER);
    private static final FieldDescriptor FUNCTION_NAME_PATTERN_DESCRIPTOR = Requests.FunctionsRequest.
            getDescriptor().findFieldByNumber(Requests.FunctionsRequest.FUNCTION_NAME_PATTERN_FIELD_NUMBER);

    public final String connectionId;
    public final String catalog;
    public final String schemaPattern;
    public final String functionNamePattern;
    ...
    @JsonCreator
    public FunctionsRequest(@JsonProperty("connectionId") String connectionId,
                            @JsonProperty("catalog") String catalog,
                            @JsonProperty("schemaPattern") String schemaPattern,
                            @JsonProperty("functionNamePattern") String functionNamePattern){
      this.connectionId = connectionId;
      this.catalog = catalog;
      this.schemaPattern = schemaPattern;
    ...
    @Override Request deserialize(Message genericMsg) {
      final Requests.FunctionsRequest msg = ProtobufService.castProtobufMessage(genericMsg,
              Requests.FunctionsRequest.class);
      ...
      if (msg.hasField(FUNCTION_NAME_PATTERN_DESCRIPTOR)) {
        functionNamePattern = msg.getFunctionNamePattern();
      }

      return new FunctionsRequest(connectionId, catalog, schemaPattern, functionNamePattern);
    }

    @Override Requests.FunctionsRequest serialize() {
      Requests.FunctionsRequest.Builder builder = Requests.FunctionsRequest.newBuilder();
      ...
      if (null != functionNamePattern) {
        builder.setFunctionNamePattern(functionNamePattern);
      }
    ...
    @Override public int hashCode() {
      ...
      result = p(result, catalog);
      result = p(result, schemaPattern);
      result = p(result, functionNamePattern);
      return result;
    }

    @Override public boolean equals(Object o) {
      return o == this
              || o instanceof FunctionsRequest
              && Objects.equals(connectionId, ((FunctionsRequest) o).connectionId)
              && Objects.equals(catalog, ((FunctionsRequest) o).catalog)
              && Objects.equals(schemaPattern, ((FunctionsRequest) o).schemaPattern)
              && Objects.equals(functionNamePattern, ((FunctionsRequest) o).functionNamePattern);
    }
  }

  class DataSourceRequest extends org.apache.calcite.avatica.remote.Service.Request {
    private static final FieldDescriptor CONNECTION_ID_DESCRIPTOR = Requests.DataSourceRequest.
            getDescriptor().findFieldByNumber(Requests.DataSourceRequest.CONNECTION_ID_FIELD_NUMBER);
    private static final FieldDescriptor DS_KEY_DESCRIPTOR = Requests.DataSourceRequest.
            getDescriptor().findFieldByNumber(Requests.DataSourceRequest.DS_KEY_FIELD_NUMBER);

    public final String connectionId;
    public final String dsKey;
    ...
    @JsonCreator
    public DataSourceRequest(@JsonProperty("connectionId") String connectionId,
                             @JsonProperty("dsKey") String dsKey){
      this.connectionId = connectionId;
      this.dsKey = dsKey;
    }

    @Override
    org.apache.calcite.avatica.remote.Service.Response accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }

    @Override
    org.apache.calcite.avatica.remote.Service.Request deserialize(Message genericMsg) {
      final Requests.DataSourceRequest msg = ProtobufService.castProtobufMessage(genericMsg,
              Requests.DataSourceRequest.class);
      ...
      String dsKey = null;
      if (msg.hasField(DS_KEY_DESCRIPTOR)) {
        dsKey = msg.getDsKey();
      }

      return new org.apache.calcite.avatica.remote.Service.DataSourceRequest(connectionId, dsKey);
    }

    @Override Requests.DataSourceRequest serialize() {
      Requests.DataSourceRequest.Builder builder = Requests.DataSourceRequest.newBuilder();

      if (null != connectionId) {
        builder.setConnectionId(connectionId);
      }
      if (null != dsKey) {
        builder.setDsKey(dsKey);
      }
      return builder.build();
    }
    ...
    @Override public int hashCode() {
      int result = 1;
      result = p(result, connectionId);
      result = p(result, dsKey);
      return result;
    }

    @Override public boolean equals(Object o) {
      return o == this
              || o instanceof org.apache.calcite.avatica.remote.Service.DataSourceRequest
              && Objects.equals(connectionId, ((org.apache.calcite.avatica.remote.Service.DataSourceRequest) o).connectionId)
              && Objects.equals(dsKey, ((org.apache.calcite.avatica.remote.Service.DataSourceRequest) o).dsKey);
    }
  }

  class QueryLogRequest extends org.apache.calcite.avatica.remote.Service.Request {
    private static final FieldDescriptor CONNECTION_ID_DESCRIPTOR = Requests.
            QueryLogRequest.getDescriptor().findFieldByNumber(
            Requests.QueryLogRequest.CONNECTION_ID_FIELD_NUMBER);
    private static final FieldDescriptor INCREMENTAL_DESCRIPTOR = Requests.
            QueryLogRequest.getDescriptor().findFieldByNumber(
            Requests.QueryLogRequest.INCREMENTAL_FIELD_NUMBER);
    private static final FieldDescriptor FETCH_SIZE_DESCRIPTOR = Requests.
            QueryLogRequest.getDescriptor().findFieldByNumber(
            Requests.QueryLogRequest.FETCH_SIZE_FIELD_NUMBER);
    ...
    @Override
    org.apache.calcite.avatica.remote.Service.QueryLogResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }

    @Override
    org.apache.calcite.avatica.remote.Service.QueryLogRequest deserialize(Message genericMsg) {
      final Requests.QueryLogRequest msg = ProtobufService.castProtobufMessage(genericMsg,
              Requests.QueryLogRequest.class);
      ...
      if (msg.hasField(INCREMENTAL_DESCRIPTOR)) {
        incremental = msg.getIncremental();
      }

      // Use the old attribute, unless the new is set
      int fetchSize = 0;
      if (msg.hasField(FETCH_SIZE_DESCRIPTOR)) {
        fetchSize = msg.getFetchSize();
      }

      return new org.apache.calcite.avatica.remote.Service.QueryLogRequest(connectionId, msg.getStatementId(), incremental, fetchSize);
    }

    @Override Requests.QueryLogRequest serialize() {
      Requests.QueryLogRequest.Builder builder = Requests.QueryLogRequest
              .newBuilder();
    ...
    @Override public int hashCode() {
      ...
      result = p(result, incremental);
      result = p(result, fetchSize);
      return result;
    }

    @Override public boolean equals(Object o) {
      return o == this
              || o instanceof org.apache.calcite.avatica.remote.Service.QueryLogRequest
              && statementId == ((org.apache.calcite.avatica.remote.Service.QueryLogRequest) o).statementId
              && incremental == ((QueryLogRequest) o).incremental
              && fetchSize == ((org.apache.calcite.avatica.remote.Service.QueryLogRequest) o).fetchSize
              && Objects.equals(connectionId, ((org.apache.calcite.avatica.remote.Service.QueryLogRequest) o).connectionId);
    }
  }
  /**
  ...
  class TableTypesRequest extends Request {
    ...
    @Override ResultSetResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Request for
   * {@link Meta#getColumns(Meta.ConnectionHandle, String, Meta.Pat, Meta.Pat, Meta.Pat)}.
   */
   ...
   * {@link Meta#getCatalogs(Meta.ConnectionHandle)} and
   * {@link Meta#getSchemas(Meta.ConnectionHandle, String, Meta.Pat)}
   * {@link Meta#getTables(Meta.ConnectionHandle, String, Meta.Pat, Meta.Pat, List)}
   * {@link Meta#getFunctions(Meta.ConnectionHandle, String, Meta.Pat, Meta.Pat)}
   * {@link Meta#getDataSource(Meta.ConnectionHandle, String)}
  ...
  class PrepareAndExecuteRequest extends Request {
    ...
    @Override ExecuteResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class PrepareRequest extends Request {
    ...
    @Override PrepareResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class FetchRequest extends Request {
    ...
    @Override FetchResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Request for
   * {@link Meta#createStatement(Meta.ConnectionHandle)}. */
  class CreateStatementRequest extends Request {
    ...
    @Override CreateStatementResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Request for
   * {@link Meta#closeStatement(Meta.StatementHandle)}. */
  class CloseStatementRequest extends Request {
    ...
    @Override CloseStatementResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class OpenConnectionRequest extends Request {
    ...
    @Override OpenConnectionResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Request for
   * {@link Meta#closeConnection(Meta.ConnectionHandle)}. */
  class CloseConnectionRequest extends Request {
    ...
    @Override CloseConnectionResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class ConnectionSyncRequest extends Request {
    ...
    @Override ConnectionSyncResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /** Response for
   * {@link Meta#getDataSource(Meta.ConnectionHandle, String)}. */
  class DataSourceResponse extends Response {
    private static final FieldDescriptor METADATA_DESCRIPTOR = Responses.ConnectionSyncResponse
            .getDescriptor().findFieldByNumber(Responses.ConnectionSyncResponse.METADATA_FIELD_NUMBER);
    ...
    @JsonCreator
    public DataSourceResponse(@JsonProperty("props") Map<String, String> props,
                                  @JsonProperty("rpcMetadata") RpcMetadataResponse rpcMetadata) {
      this.props = props;
      this.rpcMetadata = rpcMetadata;
    }

    @Override DataSourceResponse deserialize(Message genericMsg) {
      final Responses.DataSourceResponse msg = ProtobufService.castProtobufMessage(genericMsg,
              Responses.DataSourceResponse.class);
      RpcMetadataResponse metadata = null;
      if (msg.hasField(METADATA_DESCRIPTOR)) {
        metadata = RpcMetadataResponse.fromProto(msg.getMetadata());
      }

      return new DataSourceResponse(msg.getPropsMap(),
              metadata);
    }

    @Override Responses.DataSourceResponse serialize() {
      Responses.DataSourceResponse.Builder builder = Responses.DataSourceResponse
              .newBuilder();
    ...
    @Override public boolean equals(Object o) {
      return o == this
              || o instanceof DataSourceResponse
              && Objects.equals(props, ((DataSourceResponse) o).props)
              && Objects.equals(rpcMetadata, ((DataSourceResponse) o).rpcMetadata);
    }
  }

  /** Response for
   * {@link Meta#getQueryLog(Meta.StatementHandle, boolean, int)}. */
  class QueryLogResponse extends Response {
    private static final FieldDescriptor METADATA_DESCRIPTOR = Responses.ConnectionSyncResponse
            .getDescriptor().findFieldByNumber(Responses.ConnectionSyncResponse.METADATA_FIELD_NUMBER);
    ...
    @JsonCreator
    public QueryLogResponse(@JsonProperty("logs") List<String> logs,
                            @JsonProperty("rpcMetadata") RpcMetadataResponse rpcMetadata) {
      this.logs = logs;
      this.rpcMetadata = rpcMetadata;
    }

    @Override QueryLogResponse deserialize(Message genericMsg) {
      final Responses.QueryLogResponse msg = ProtobufService.castProtobufMessage(genericMsg,
              Responses.QueryLogResponse.class);
      RpcMetadataResponse metadata = null;
      if (msg.hasField(METADATA_DESCRIPTOR)) {
        metadata = RpcMetadataResponse.fromProto(msg.getMetadata());
      }

      return new QueryLogResponse(msg.getLogsList(),
              metadata);
    }

    @Override Responses.QueryLogResponse serialize() {
      Responses.QueryLogResponse.Builder builder = Responses.QueryLogResponse
              .newBuilder();
    ...
    @Override public boolean equals(Object o) {
      return o == this
              || o instanceof QueryLogResponse
              && Objects.equals(logs, ((QueryLogResponse) o).logs)
              && Objects.equals(rpcMetadata, ((QueryLogResponse) o).rpcMetadata);
    }
  }
  /** Response for
   * {@link Meta#getDatabaseProperties(Meta.ConnectionHandle)}. */
   ...
   * transport over the wire. Thus, {@link org.apache.calcite.avatica.remote.Service#apply} will never return
   * an ErrorResponse.
   */
  ...
  /**
   * Request for {@link org.apache.calcite.avatica.remote.Service#apply(SyncResultsRequest)}
   */
  class SyncResultsRequest extends Request {
    ...
    SyncResultsResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  /**
   * Response for {@link org.apache.calcite.avatica.remote.Service#apply(SyncResultsRequest)}.
   */
  ...
  class CommitRequest extends Request {
    ...
    @Override CommitResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class RollbackRequest extends Request {
    ...
    @Override RollbackResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
  ...
  class PrepareAndExecuteBatchRequest extends Request {
    ...
    @Override public ExecuteBatchResponse accept(org.apache.calcite.avatica.remote.Service service) {
      return service.apply(this);
    }
