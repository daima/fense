 ...
 * {@link Accessor} implementations if it
 * wishes.</p>
 */
...
//        return new FixedStringAccessor(getter, columnMetaData.displaySize);
  ...
  private static class LongAccessor extends ExactNumericAccessor {
    ...
    public long getLong() throws SQLException {
      ...
      if (object instanceof Integer){
        Long o = Long.parseLong(String.valueOf(object));
        return o == null ? 0 : o;
      }
   ...
   * corresponds to {@link Types#DOUBLE}.
   */
   ...
   * corresponds to {@link Types#DECIMAL}.
   */
   ...
   * corresponds to {@link Types#NUMERIC}.
   *
   ...
   * corresponds to {@link Types#CHAR}
   ...
   * corresponds to {@link Types#BINARY}
   * and {@link Types#VARBINARY}.
   */
  ...
  /**
   * Accessor that assumes that the underlying value is a {@link String},
   * encoding {@link Types#BINARY}
   * and {@link Types#VARBINARY} values in Base64 format.
   */
   ...
   * corresponds to {@link Types#DATE}.
   */
   ...
   * in its default representation {@code int};
   * corresponds to {@link Types#TIME}.
   */
   ...
   * corresponds to {@link Types#TIMESTAMP}.
   */
   ...
   * corresponds to {@link Types#OTHER}.
   */
   ...
   * corresponds to {@link Types#ARRAY}.
   */
   ...
   * corresponds to {@link Types#STRUCT}.
   */
   ...
   * corresponds to {@link Types#JAVA_OBJECT}.
   */
